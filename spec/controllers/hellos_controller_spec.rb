...
RSpec.describe HellosController, type: :controller do
  ...
  # Hello. As you add validations to Hello, be sure to
  ...
  describe "GET #index" do
    it "assigns all hellos as @hellos" do
      ...
      expect(assigns(:hellos)).to eq([hello])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested hello as @hello" do
      hello = Hello.create! valid_attributes
      get :show, {:id => hello.to_param}, valid_session
      expect(assigns(:hello)).to eq(hello)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new hello as @hello" do
      ...
      expect(assigns(:hello)).to be_a_new(Hello)
    end
  end
  ...
  describe "GET #edit" do
    it "assigns the requested hello as @hello" do
      hello = Hello.create! valid_attributes
      get :edit, {:id => hello.to_param}, valid_session
      expect(assigns(:hello)).to eq(hello)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created hello as @hello" do
        post :create, {:hello => valid_attributes}, valid_session
        expect(assigns(:hello)).to be_a(Hello)
        expect(assigns(:hello)).to be_persisted
      end

      it "redirects to the created hello" do
        post :create, {:hello => valid_attributes}, valid_session
        expect(response).to redirect_to(Hello.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved hello as @hello" do
        post :create, {:hello => invalid_attributes}, valid_session
        expect(assigns(:hello)).to be_a_new(Hello)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hello" do
        hello = Hello.create! valid_attributes
        put :update, {:id => hello.to_param, :hello => new_attributes}, valid_session
        hello.reload
      ...
      it "assigns the requested hello as @hello" do
        hello = Hello.create! valid_attributes
        put :update, {:id => hello.to_param, :hello => valid_attributes}, valid_session
        expect(assigns(:hello)).to eq(hello)
      end
    ...
    context "with invalid params" do
      it "assigns the hello as @hello" do
        hello = Hello.create! valid_attributes
        put :update, {:id => hello.to_param, :hello => invalid_attributes}, valid_session
        expect(assigns(:hello)).to eq(hello)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the hellos list" do
      hello = Hello.create! valid_attributes
      delete :destroy, {:id => hello.to_param}, valid_session
      expect(response).to redirect_to(hellos_url)
    end
  end
